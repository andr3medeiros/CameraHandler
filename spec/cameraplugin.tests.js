...
describe('cordova.require object should exist', function () {
	...
	it("CameraPlugin plugin should exist", function() {
        trierplugin = cordova.require("cordova/plugin/CameraHandler")
        expect(trierplugin).toBeDefined();
		expect(typeof trierplugin == 'object').toBe(true);
	});

    it("should contain a isAutoFocus function", function() {
        expect(trierplugin.isAutoFocus).toBeDefined();
        expect(typeof trierplugin.isAutoFocus == 'function').toBe(true);
    });
});
